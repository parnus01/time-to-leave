...
class Calendar {
    ...
    _draw () {
        ...
        let waivedInfo = this._getWaiverStore(this._getTodayDate(),
            this._getTodayMonth(),
            this._getTodayYear())
        let showCurrentDay = this._showDay(this._getTodayYear(),
            this._getTodayMonth(),
            this._getTodayDate())
    ...
    _updateBasedOnDB () {
        ...
        for (let day = 1; day <= monthLength; ++day) {
            ...
            let waivedInfo = this._getWaiverStore(day,
    ...
    _updateLeaveBy () {
        ...
        let [dayBegin, lunchBegin, lunchEnd, dayEnd] = this._getDaysEntries(this._getTodayMonth(),
            this._getTodayDate())
